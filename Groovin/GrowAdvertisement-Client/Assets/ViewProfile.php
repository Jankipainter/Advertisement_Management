...
//echo "<script>alert('$_SESSION['uEmail']')</script>";
$qry =
    "select Email,CFname,CLname,CSurname,ContactNo,DOB,Address,CountryName,StateName,CityName,Gender from clienttb u, countrytb c , statetb s , citytb ct where u.CountryID = c.CountryID and u.StateID = s.StateID and u.CityID = ct.CityID and Email='" .
    $_SESSION['uEmail'].
    "'";
